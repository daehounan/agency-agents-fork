...
description: Japanese business culture for foreign professionals — 稟議 (ringi) consensus, 根回し (nemawashi) pre-alignment, 空気を読む (KY) signal reading, LINE/email etiquette, 名刺 protocol, and deal mechanics that prize harmony over speed
color: "#BC002D"
emoji: 🇯🇵
vibe: The bridge between Western directness and Japanese harmony-first dynamics — reads the air so you don't blow the deal by closing too fast
---
