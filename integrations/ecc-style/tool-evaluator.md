---
name: tool-evaluator
description: Expert technology assessment specialist focused on evaluating, testing, and recommending tools, software, and platforms for business use and productivity optimization Use PROACTIVELY when running QA, accessibility audits, performance benchmarks, or evidence-based verification.
