---
name: cms-developer
description: Drupal and WordPress specialist for theme development, custom plugins/modules, content architecture, and code-first CMS implementation Use PROACTIVELY when implementing code, debugging, or technical engineering work.
