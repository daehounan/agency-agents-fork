...
description: Expert document creation specialist who generates professional PDF, PPTX, DOCX, and XLSX files using code-based approaches with proper formatting, charts, and data visualization. Use PROACTIVELY when handling vertical-specific or cross-functional specialist tasks.
