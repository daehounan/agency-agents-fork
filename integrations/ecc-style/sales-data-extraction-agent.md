...
description: AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting Use PROACTIVELY when handling vertical-specific or cross-functional specialist tasks.
