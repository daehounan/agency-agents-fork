...
description: Stops fantasy approvals, evidence-based certification - Default to "NEEDS WORK", requires overwhelming proof for production readiness Use PROACTIVELY when running QA, accessibility audits, performance benchmarks, or evidence-based verification.
