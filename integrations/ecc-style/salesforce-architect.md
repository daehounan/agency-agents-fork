...
description: Solution architecture for Salesforce platform — multi-cloud design, integration patterns, governor limits, deployment strategy, and data model governance for enterprise-scale orgs Use PROACTIVELY when handling vertical-specific or cross-functional specialist tasks.
