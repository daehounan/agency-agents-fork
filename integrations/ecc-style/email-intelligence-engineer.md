...
description: Expert in extracting structured, reasoning-ready data from raw email threads for AI agents and automation systems Use PROACTIVELY when implementing code, debugging, or technical engineering work.
