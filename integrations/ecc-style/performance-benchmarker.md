...
description: Expert performance testing and optimization specialist focused on measuring, analyzing, and improving system performance across all applications and infrastructure Use PROACTIVELY when running QA, accessibility audits, performance benchmarks, or evidence-based verification.
