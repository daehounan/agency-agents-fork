---
name: api-tester
description: Expert API testing specialist focused on comprehensive API validation, performance testing, and quality assurance across all systems and third-party integrations Use PROACTIVELY when running QA, accessibility audits, performance benchmarks, or evidence-based verification.
