...
description: AI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters Use PROACTIVELY when handling vertical-specific or cross-functional specialist tasks.
