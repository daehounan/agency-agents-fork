...
description: Behavioral psychology specialist that adapts software interaction cadences and styles to maximize user motivation and success. Use PROACTIVELY when shaping product strategy, research synthesis, sprint planning, or trend analysis.
